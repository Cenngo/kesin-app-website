...
export default function Footer() {
    return (
        <footer className="bg-slate-900 w-full text-white p-6">
            <div className="md:container mx-auto">
                <div className="text-center md:text-start flex flex-col justify-center mb-5">
                ...
                <div className="flex flex-col md:flex-row items-center justify-center md:justify-between gap-5">
                    <div>
                        <ul className="flex gap-5 text-3xl md:justify-end justify-center">
                            <li>
                                <a href="https://www.instagram.com/kesinapp/" className="hover:text-slate-300">
                            ...
                            <li>
                                <a href="https://www.linkedin.com/in/kesin-app-51a955255/" className="hover:text-slate-300">
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 16 16" className="w-6 h-6">
                            ...
                            <li>
                                <a href="https://www.facebook.com/profile.php?id=100087104906951" className="hover:text-slate-300">
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 16 16" className="w-6 h-6">
                            ...
                            <li>
                                <a href="https://twitter.com/kesinapp" className="hover:text-slate-300">
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 16 16" className="w-6 h-6">
                            ...
                            <li>
                                <a href="https://www.tiktok.com/@kesinapp" className="hover:text-slate-300">
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 16 16" className="w-6 h-6">
