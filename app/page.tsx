  ...
  return (
    <main className="bg-background min-h-screen items-center justify-betweeen">
      <section className="min-h-screen flex flex-col justify-center items-center gap-4 pb-5 relative">
        <Image src={divier} alt='divider' className="w-full absolute top-0 left-0 hidden lg:block"/>
        <div className="mb-3 relative lg:z-20 pt-20">
            <div className="text-b max-w-[657px] mb-10">
              ...
              <h3 className="text-lg text-center mx-5">KESiN kullanıcıları çekilişleri rahatlıkla görebiliyor, katılım koşullarını uygulayarak hızlıca katılabiliyor ve sonuçları kolaylıkla takip edebiliyor.</h3>
            </div>
            <div className="flex flex-col items-center relative">
              <div className="flex lg:flex-col flex-col-reverse">
                <ExploreButton href="/about-us" className="mx-auto relative z-20">Keşfet</ExploreButton>
                <Image src={giftImage} alt='gift' className='max-h-[720px] w-auto mx-auto -mt-12 lg:mb-0 -mb-8'/>
              </div>
              <div className="flex flex-col gap-3 justify-center items-center w-[298px] mx-auto mt-16 lg:absolute lg:top-20 lg:-right-56 relative z-20">
                <AppStoreBtn/>
                <PlayStoreBtn/>
              </div>
            </div>
        </div>
        <Image src={mobileBackdropImage} alt='mobile-backdrop' className='w-full lg:hidden block absolute top-[550px] h-[425px] left-0 z-10'/>
      </section>
