      ...
      <section className="min-h-screen flex flex-col justify-center items-center gap-4 pb-5 relative">
        ...
        <div className="mb-3 relative lg:z-20 pt-10 flex flex-col-reverse lg:block">
            <div className="text-b max-w-[657px] mb-10 flex flex-col justify-center item-center">
              ...
              <div className="flex flex-col gap-3 justify-center items-center w-[320px] mx-auto lg:absolute lg:top-20 lg:-right-56 relative z-20 lg:hidden">
                <AppStoreBtn/>
                <PlayStoreBtn/>
              </div>
            </div>
            <div className="flex justify-center relative">
              <Image src={giftImage} alt='gift' className='max-h-[720px] w-auto mx-auto lg:-ml-5 -mt-12 lg:mb-0 -mb-8 lg:-mt-36 relative top-[40px] lg:block'/>
              <div className="flex-col gap-3 justify-center items-center w-[320px] mx-auto mt-16 lg:absolute lg:top-20 lg:-right-56 relative z-20 hidden lg:flex">
                <AppStoreBtn/>
                <PlayStoreBtn/>
              </div>
            </div>
        </div>
        <Image src={mobileBackdropImage} alt='mobile-backdrop' className='w-full lg:hidden block absolute z-10 top-[280px]'/>
      </section>
      <section className="flex flex-col justify-between items-center min-h-screen md:min-h-fit bg-[#f1f1f1] pb-24">
        <div className="container mx-auto">
          <h4 className="lg:text-5xl text-2xl font-bold text-center my-5 text-b max-w-[726px] mx-auto">KESiN’le çekilişlere katılmak hem KOLAY hem de ÜCRETSİZ</h4>
