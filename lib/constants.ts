export const faqs =[    
    {
        ...
        questions: [
            ...
            {
                question: "Yani şimdi ben uygulamayı indiriyorum, reklamı izliyorum, pat çekilişe katıldım. Olur mu öyle şey ?",
                answer: "Aynen öyle ! Ücretsiz, tek bir kere giriş yaparak, evinde oturduğun yerden listelediğin çekilişler arasından istediğine katılabilirsin. Bu arada unutmadan çekilişlerimizin canlı yayınlarını izlemek için youtube kanalımızı takip etmeyi unutma !"
            },
            {
                question: "Marka olarak size nasıl ulaşabilirim??",
                answer: "Bizlere www.kesin.app web sitemizden ya da info@kesin.app adresine mail atarak ulaşabilirsin."
            },
        ]
    },
    {
        ...
        questions: [
            ...
            },
            {
                ...
                answer: "Katıldığım Çekilişler sekmesinde aynı zamanda geçmiş dönemde ki çekilişi kazanan kişinin profiline erişim sağlayabilirsiniz."
            },
